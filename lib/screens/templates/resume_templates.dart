    ...
    pw.Page(
      ...
      build: (pw.Context context) => pw.Row(
        children: [
          ...
          pw.Expanded(
            child: pw.Container(
              padding: const pw.EdgeInsets.fromLTRB(18, 20, 24, 20),
              child: pw.Column(
                crossAxisAlignment: pw.CrossAxisAlignment.start,
                children: [
                  // About Section
          ...
          pw.Container(
            ...
            child: pw.Column(
              ...
              children: [
                // Profile Section
                pw.Container(
                  padding: const pw.EdgeInsets.all(16), // Reduced from 16
                  decoration: pw.BoxDecoration(
                    color: PdfColors.grey100,
                    borderRadius: pw.BorderRadius.circular(8), // Reduced from 8
                  ),
                  child: pw.Column(
                    crossAxisAlignment: pw.CrossAxisAlignment.center,
                    children: [
                      ...
                      //   margin: const pw.EdgeInsets.only(
                      //       bottom: 12), // Reduced from 12
                      //   decoration: pw.BoxDecoration(
                      //     shape: pw.BoxShape.circle,
                      //     border: pw.Border.all(
                      //         color: PdfColors.grey400,
                      //         width: 1.6), // Reduced from 2
                      //   ),
                      //   child: pw.ClipOval(
                      //     child: pw.Image(
                      //       pw.MemoryImage(data.profileImageBytes!),
                      ...
                      pw.SizedBox(height: 4), // Reduced from 4
                      pw.Text(
                        data.currentPosition,
                        style: pw.TextStyle(
                ...
                pw.SizedBox(height: 16), // Reduced from 16

                // Contact Information
                pw.Container(
                  padding: const pw.EdgeInsets.all(12), // Reduced from 12
                  decoration: pw.BoxDecoration(
                    border: pw.Border.all(color: PdfColors.grey300),
                    borderRadius: pw.BorderRadius.circular(8), // Reduced from 8
                  ),
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      pw.SizedBox(height: 8), // Reduced from 8
                ...
                if (data.hobbies.isNotEmpty)
                  pw.Container(
                    ...
                    decoration: pw.BoxDecoration(
                      border: pw.Border.all(color: PdfColors.grey300),
                      borderRadius:
                      pw.BorderRadius.circular(8), // Reduced from 8
                    ),
                    child: pw.Column(
                      crossAxisAlignment: pw.CrossAxisAlignment.start,
                      children: [
          ...
          pw.Expanded(
            child: pw.Column(
              ...
              children: [
                ...
                pw.Container(
                  padding:
                  const pw.EdgeInsets.only(bottom: 10), // Reduced from 10
                  child: pw.Text(
                    data.bio,
                    style: const pw.TextStyle(
                        fontSize: 11, lineSpacing: 1.2), // Reduced from 11
                    textAlign: pw.TextAlign.justify,
                  ),
                ),
                      ...
                      children: [
                        pw.Text('ABOUT ME',
                            style: pw.TextStyle(
                                ...
                                letterSpacing: 1.5)),
                        pw.SizedBox(height: 6),
                        pw.Text(data.bio, style: pw.TextStyle(fontSize: 12)),
